    ...
    'translation': {
        ...
        travelTips: {
            ...
            data: {
                ...
                content_italicized1: '',
                content1: 'La Loi sur le patrimoine historique garantit la préservation du patrimoine historique du Yukon. Si vous trouvez un artéfact, laissez-le en place, ne le déplacez pas. Où que vous soyez au Yukon, vous vous trouvez sur le territoire traditionnel d’une Première Nation. Chaque Première Nation, en collaboration avec le gouvernement du Yukon, travaille à honorer et à protéger le patrimoine vivant du territoire.',
                contacts1: {
                    name1: 'Si vous trouvez un artéfact, contactez-nous au ',
                    contact1: '867-471-0950',
                    name2: ' ou à ',
                    contact2: 'info@yukonlivingheritage.ca',
                },
