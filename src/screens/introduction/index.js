...
const mapDispatchToProps = dispatch => {
  return {
    dispatchSetOnboardingFinished: value =>
      dispatch(setOnboardingFinished(value)),
  };
};
