...
const mapDispatchToProps = dispatch => {
  return {
    ...
    dispatchGetUserToSiteDistance: (userLocation, site, cachedDistances) =>
      dispatch(getUserToSiteDistance(userLocation, site, cachedDistances)),
    dispatchSiteDistance: (site_id, distance) =>
      dispatch(setSiteDistance(site_id, distance)),
  };
};
