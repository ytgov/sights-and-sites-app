  ...
  return (
    <ParallaxScrollView
      ...
      renderScrollComponent={props => (
        <Animated.ScrollView {...props} scrollIndicatorInsets={{right: 1}} />
      )}
      outputScaleValue={1.2} // max zoom level
      renderFixedHeader={() => {
        return search && <View style={{width: windowWidth}}>{search}</View>;
      }}
      ...
      <View>
        ...
        />
        <View style={{marginVertical: 16}}>{children}</View>
      </View>
    </ParallaxScrollView>
  );
};
