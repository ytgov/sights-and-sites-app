...
export const APP_CONFIG = {
  ...
  cache: {
    imagePreview:
      'data:image/png;base64,',
    transitionDuration: 500,
    tint: 'dark',
  },
  map_box:
    'pk.eyJ1IjoieWdlc2VydmljZXMiLCJhIjoiY2s4MDgyZ3JhMGQ0dDNscGU1YmplOTEzNCJ9.94bGsBH18qzFY-Cd5kjZvA',
